...
<template>
    ...
    <div v-if="selectedLocale.city_dist" class="mb-6">
        <h3>Candidates for {{ selectedLocale.province }} > <b>{{ selectedLocale.city_dist }}</b></h3>
    </div>

    <div class="flex flex-wrap -mx-4" v-if="store.dataSource.loading">
        <CardLoading :compact="true" v-for="index in 5" :key="index"></CardLoading>
    </div>

    <div v-if="!store.dataSource.loading">
        <div v-if="store && selectedLocale.city_dist">
            <!-- MEMBER, HOUSE OF REPRESENTATIVES -->
            <div v-if="store.houseRepresentatives.length" class="mb-6">
            ...
            <!-- PROVINCIAL GOVERNOR  -->
            <div v-if="store.governors.length" class="mb-6">
            ...
            <div v-if="store.viceGovernors.length" class="mb-6">
            ...
            <div v-if="store.provSangMembers.length" class="mb-6">
            ...
            <!-- MAYOR  -->
            <div v-if="store.mayors.length" class="mb-6">
            ...
            <!-- VICE MAYOR  -->
            <div v-if="store.viceMayors.length" class="mb-6">
            ...
            <div v-if="store.citySangMembers.length" class="mb-6">
    ...
    <div class="text-lg md:text-xl lg:text-2xl text-center lg:p-8 py-8" v-if="!selectedLocale.city_dist">
